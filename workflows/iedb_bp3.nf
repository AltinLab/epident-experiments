...
workflow {
  ...
  main:
  CLEAN_IEDB_BP3(Channel.fromPath(params.input))

  inf_dir = file("$params.inf_dir").toUriString()

  bp3_pq = CLEAN_IEDB_BP3.out.filt_pq
  discard_pq = CLEAN_IEDB_BP3.out.discard_pq
